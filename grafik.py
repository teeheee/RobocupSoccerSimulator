...
class RobotGrafik: #TODO Display Motor speed and add Ballcapture zone
    ...
    def draw(self):
        pos = int((self.x_position + self.x_position_offset) * self.ppcm), \
              int((self.y_position + self.y_position_offset) * self.ppcm)
        pygame.draw.circle(self.display, self.color, pos, int(10 * self.ppcm))
        pos = (pos[0] - 5, pos[1] - 8)
...
class FeldGrafik: #TODO linien nicht korrekt
    ...
    def draw(self):
        ...
        r2 = Rect(
            ...
            ((self.outer_size[1] - 90) / 2) * self.ppcm, 30 * self.ppcm, 90 * self.ppcm)
        pygame.draw.rect(self.display, BLACK, r1, int(self.linewidth * self.ppcm))
        pygame.draw.rect(self.display, BLACK, r2, int(self.linewidth * self.ppcm))
        ...
        pygame.draw.line(self.display, WHITE, p1, p2, int(self.linewidth * self.ppcm))
        pygame.draw.line(self.display, WHITE, p2, p3, int(self.linewidth * self.ppcm))
        pygame.draw.line(self.display, WHITE, p3, p4, int(self.linewidth * self.ppcm))
        pygame.draw.line(self.display, WHITE, p4, p1, int(self.linewidth * self.ppcm))
        ...
        pygame.draw.circle(self.display, BLACK, p1, int(30 * self.ppcm), 1)
        ...
        pygame.draw.circle(self.display, BLACK, p1, int(1 * self.ppcm))
        pygame.draw.circle(self.display, BLACK, p2, int(1 * self.ppcm))
        pygame.draw.circle(self.display, BLACK, p3, int(1 * self.ppcm))
        pygame.draw.circle(self.display, BLACK, p4, int(1 * self.ppcm))
        pygame.draw.circle(self.display, BLACK, p5, int(1 * self.ppcm))
