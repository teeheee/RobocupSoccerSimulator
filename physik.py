...
class FieldPhysik:
	def __init__(self,_space):
		...
		#Auslinien
		static_body = self.space.static_body
		self.auslinien = [pymunk.Segment(static_body, (-gc.INNER_FIELD_LENGTH/2, -gc.INNER_FIELD_WIDTH/2), (-gc.INNER_FIELD_LENGTH/2, gc.INNER_FIELD_WIDTH/2), 0.0)
		                ,pymunk.Segment(static_body, (-gc.INNER_FIELD_LENGTH/2, -gc.INNER_FIELD_WIDTH/2), (gc.INNER_FIELD_LENGTH/2, -gc.INNER_FIELD_WIDTH/2), 0.0)
		                ,pymunk.Segment(static_body, (gc.INNER_FIELD_LENGTH/2, gc.INNER_FIELD_WIDTH/2), (-gc.INNER_FIELD_LENGTH/2, gc.INNER_FIELD_WIDTH/2), 0.0)
		                ,pymunk.Segment(static_body, (gc.INNER_FIELD_LENGTH/2, gc.INNER_FIELD_WIDTH/2), (gc.INNER_FIELD_LENGTH/2, -gc.INNER_FIELD_WIDTH/2), 0.0)]
...
class TorPhysik:
	def __init__(self,_space):
		...
		static_lines_tor2 = [pymunk.Segment(static_body, (-gc.INNER_FIELD_LENGTH/2, gc.GOAL_WIDTH/2) 			   , (-gc.INNER_FIELD_LENGTH/2-gc.GOAL_DEEP, gc.GOAL_WIDTH/2),0.0)
							,pymunk.Segment(static_body, (-gc.INNER_FIELD_LENGTH/2-gc.GOAL_DEEP, gc.GOAL_WIDTH/2)  , (-gc.INNER_FIELD_LENGTH/2-gc.GOAL_DEEP, -gc.GOAL_WIDTH/2),0.0)
							,pymunk.Segment(static_body, (-gc.INNER_FIELD_LENGTH/2-gc.GOAL_DEEP, -gc.GOAL_WIDTH/2) , (-gc.INNER_FIELD_LENGTH/2, -gc.GOAL_WIDTH/2),0.0)]
		tor_balken_1 = pymunk.Segment(static_body, (gc.INNER_FIELD_LENGTH/2, -gc.GOAL_WIDTH/2), (gc.INNER_FIELD_LENGTH/2, gc.GOAL_WIDTH/2), 0.0)
		tor_balken_2 = pymunk.Segment(static_body, (-gc.INNER_FIELD_LENGTH/2, -gc.GOAL_WIDTH/2), (-gc.INNER_FIELD_LENGTH/2, gc.GOAL_WIDTH/2), 0.0)
